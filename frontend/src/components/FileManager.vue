    ...
    <div class="file-manager card">
        <div class="flex items-center justify-between mb-6">
            ...
            <button class="btn btn-primary btn-sm" @click="fileInput?.click()" :disabled="isUploading">
                <svg v-if="!isUploading" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="file-list grid gap-4">
            ...
            <div v-for="file in files" :key="file.id" class="file-card glass-card p-4 flex items-center justify-between">
                ...
                <div class="flex gap-2">
                    <a :href="`/api/files/download/${file.id}`" target="_blank" class="icon-btn-sm hover:text-primary-600">
