...
const props = withDefaults(defineProps<{ modelValue:string; options:ComboboxOption[]; label:string; placeholder?:string; help?:string; error?:string; required?:boolean; allowCreate?:boolean }>(), { placeholder:'', allowCreate:true })
