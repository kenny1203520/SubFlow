...
const workspace=reactive({groups:[group],currentGroupId:'group-1',currentGroup:group,currentMembership:{userId:'user-1',role:'owner'},isOwner:true,members:[],invitations:[],subscriptions:[],expenses:[],settlements:[],groupPermissions:['group.audit.read'],groupAuditLogs:[],groupErrors:{access:'',members:'',subscriptions:'',expenses:'',settlements:'',summary:''},personalSubscriptions:[],personalExpenses:[],personalSummary:null,summary:null,loading:false,error:'',localizedError:'',permissionDenied:false,loadGroups:vi.fn(async()=>{}),selectGroup:vi.fn(async()=>{}),refreshDashboard:vi.fn(async()=>{}),refreshPersonal:vi.fn(async()=>{}),refreshGroup:vi.fn(async()=>{}),loadGroupAuditLogs:vi.fn(async()=>{}),retryLast:vi.fn()})
