...
const canWrite=computed(()=>personal.value||workspace.groupPermissions.includes('*')||workspace.groupPermissions.includes('ledger.expenses.write'))
const canDelete=computed(()=>personal.value||workspace.groupPermissions.includes('*')||workspace.groupPermissions.includes('ledger.expenses.delete'))
