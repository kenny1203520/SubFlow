        ...
        <div class="auth-card glass-panel animate-fade-in-up">
            ...
            <form @submit.prevent="handleSubmit" class="auth-form">
                <div class="form-group">
                    ...
                    <div class="relative">
                        <input v-model="password" :type="showPassword ? 'text' : 'password'" required class="glass-input pr-12" />
                ...
                <div class="form-group">
                    ...
                    <div class="relative">
                        <input v-model="confirmPassword" :type="showConfirmPassword ? 'text' : 'password'" required class="glass-input pr-12" />
