...
export interface Income extends ConvertedRecord, OfflineState { id:string;ownerId:string;title:string;category:string;amountMinor:number;currency:Currency;receivedOn:string;notes:string;createdAt:string;updatedAt:string }
