...
export interface SetupStatus { initialized:boolean; siteName?:string; defaultTimezone?:string; defaultCurrency?:string; allowRegistration?:boolean; currencies?:CurrencyInfo[] }
