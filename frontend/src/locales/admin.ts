export const adminExtras = {
  'zh-TW': { systemAdministration:'系統管理',openPocketBase:'開啟 PocketBase 後台',adminOverview:'總覽',userManagement:'使用者管理',roleManagement:'角色管理',auditLogs:'稽核日誌',permissions:'權限',assignRole:'指派角色',protectedRole:'受保護',noUsers:'找不到使用者',verificationSent:'帳號已建立，請至信箱開啟 PocketBase 驗證連結。' },
  en: { systemAdministration:'System administration',openPocketBase:'Open PocketBase admin',adminOverview:'Overview',userManagement:'User management',roleManagement:'Role management',auditLogs:'Audit logs',permissions:'Permissions',assignRole:'Assign role',protectedRole:'Protected',noUsers:'No users found',verificationSent:'Account created. Check your email for the PocketBase verification link.' },
} as const

export const systemPermissionText = {
  'zh-TW': {
    'system.roles.manage': { title:'管理系統角色', description:'建立、編輯與刪除系統角色及其權限。' },
    'system.users.assign': { title:'指派使用者角色', description:'檢視使用者並為其指派系統角色。' },
    'system.audit.read': { title:'檢視稽核日誌', description:'查看全站操作與安全稽核紀錄。' },
