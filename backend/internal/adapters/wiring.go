...
func New(driver string, app core.App) (Stores, error) {
	...
	case "", "pocketbase":
		...
		return Stores{s.Groups, s.Memberships, s.Invitations, s.Notifications, s.Subscriptions, s.Expenses, s.Settlements, s.Categories, s.ExchangeRates, s.Roles, s.Audits, s.Users, s.Settings, s.Transactions}, nil
	case "postgres", "mysql":
